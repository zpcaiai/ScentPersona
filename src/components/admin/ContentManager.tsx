  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2 rounded-xl border border-cream-200 bg-cream-50 p-4 text-sm">
        ...
        <input className="w-full rounded border border-cream-300 px-2 py-1.5" placeholder={pick(locale, "Hero 图 URL（可选）", "Hero image URL (optional)")} value={f.heroImageUrl} onChange={(e) => setF({ ...f, heroImageUrl: e.target.value })} />
